...
const long Calibrate_Offset = 13513;// Change this per your calibration. Set Calibrate_Offset = (Dial Freq/(True Freq - Dial Freq))
...
void Display_Freq(long freq) {
  ...
  if (Band != 60) { 
    ...
    display.print(String(Band) +"m Freq (kHz)");

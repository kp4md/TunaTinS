 ...
 *   -- Corrected Calibration Offset application to 60m
 * Revised 12 April 2021 by Carol Milazzo KP4MD
 *   -- added 160m, 17m and 12m and their default frequencies
 *   -- Corrected Calibration Offset to work for all bands 
...
int Band = 40;                      // Define frequency band (160, 80, 60, 40, 30, 20, 17, 15, 12, 10)
                                    //
...
const long Calibrate_Offset = 13513;// Change this per your calibration. Initialize to zero. Measure True Frequency.
                                    // Your value of Calibrate_Offset = (Dial Freq/(True Freq - Dial Freq))
long oldFreq = 0;
int TR_State = 0;
...
void isr ()  {                    // Interrupt Service Routine runs if Rotary Encoder CLK pin falls
 ...
 switch (Band) {
      ...
      case 12:  Band = 15; Freq12 = Freq1; Freq1 = Freq15; break;
      case 10:  Band = 12; Freq10 = Freq1; Freq1 = Freq12; break;
      default:  break;
    }
      }
      else {
 ...
 if (deltaFreq == 0) {
  switch (Band) {
      ...
      case 15:  Band = 12; Freq15 = Freq1; Freq1 = Freq12; break;
      case 12:  Band = 10; Freq12 = Freq1; Freq1 = Freq10; break;
...
void SetFreq(int Band, long Freq) {     // Use SI5351 Fractional Mode to set frequency at Port output
  ...
  if (Band == 60) {
    switch ((int)Freq) {
      case 1:  n = 5332000L; break;     // 60 meter Channel Frequencies
      case 2:  n = 5348000L; break;
      case 3:  n = 5358500L; break;
      case 4:  n = 5373000L; break;
      case 5:  n = 5405000L; break;
      default: break;
    }
    if (Calibrate_Offset !=0) {
      n -= int(n / Calibrate_Offset);      // Adjust for Calibrate_Offset
    }
    d = 17500; k = 142; l = 857143; m = 1000000; n -= 4900000L; n /= 10L;
    
  clockgen.setupPLL(SI5351_PLL_B, 28, n, d);
  clockgen.setupMultisynth(1, SI5351_PLL_B, k, l, m);
   ...
   switch (Band) {
      ...
      case 60:  d = 17500; k = 142; l = 857143; m = 1000000; Freq -= 4900000L; Freq /= 10L; break;
      ...
      case 12:  d = 87500; k = 28; l = 571429; m = 1000000; Freq -= 24500000L; Freq /= 10L; break;
...
void Display_Freq(long freq) {
  ...
  if (Band != 60) { 
    ...
    display.setTextSize(1);
    display.setCursor(display.width() / 2 - (Bandstring.length() + strlen("Freq (kHz)")) * 6 / 2, 0); // Each character is approximately 6 pixels wide in default type font
    display.print(Bandstring +"Freq (kHz)");
    ...
    display.setCursor(display.width() / 2 - 38, 10);
      switch(freq) {
      case 1: display.print("5332.00"); break;
      case 2: display.print("5348.00"); break;
      case 3: display.print("5358.50"); break;
      case 4: display.print("5373.00"); break;
      case 5: display.print("5405.00"); break;   
    }
    display.setTextSize(1);
    if (deltaFreq == 0) { 
